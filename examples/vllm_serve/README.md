...
Hybrid attention/Mamba models such as Nemotron 3 Nano are supported on vLLM 0.26.0, 0.28.0,
and 0.29.0. For example, calibrate and serve with NVFP4 KV-cache fakequant as follows:
