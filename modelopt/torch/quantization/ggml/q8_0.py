...
def q8_0_fake_quant(
    ...
    *,
    ...
    """Q8_0 weight backend for TensorQuantizer, with pass-through backward."""
    if getattr(quantizer, "num_bits", None) != "q8_0":
        raise ValueError("The ggml Q8_0 backend requires num_bits='q8_0'")
