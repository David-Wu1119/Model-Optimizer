...
class DFlashConfig(ModeloptBaseConfig):
    ...
    dflash_fp32_master_weights: bool = ModeloptField(
        ...
        description=(
            ...
            "the exported drafter is unchanged. The cost is memory in the optimizer: about "
            "12 bytes per draft parameter for the master plus Adam's two moments, instead of "
            "4. Gradients stay in the base dtype, so unlike an fp32 model this does not "
            "double the DDP gradient all-reduce.\n\n"
