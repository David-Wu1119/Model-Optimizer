...
class GPTModelExporter:
    ...
    def save_pretrained(
        ...
        elif quantization_format in GGML_QUANTIZATION_FORMATS:
    ...
    def _get_quantized_state(
        ...
        is_iq = qformat in GGML_QUANTIZATION_FORMATS
    ...
    def _pack_iq_weight(weight: torch.Tensor, qformat: str) -> torch.Tensor:
        ...
        packed_weight, _ = _GGML_QUANTIZERS[qformat](weight)
    ...
    def _reject_unsupported_fused_iq_export(qformat: str) -> None:
        ...
        """
        if qformat in GGML_QUANTIZATION_FORMATS:
            raise NotImplementedError(
    ...
    def _grouped_mlp_slicing(
        ...
        try:
            for local_id in range(num_experts):
                ...
                if qformat not in GGML_QUANTIZATION_FORMATS:
                    weight = weight.cpu()
                weight_scale_cpu = (
