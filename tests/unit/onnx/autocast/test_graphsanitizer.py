...
def test_find_custom_nodes_uses_source_model_path(
    ...
    tensor_info = {
        "Y": {"dtype": TensorProto.FLOAT4E2M1, "shape": [1]},
        "scale": {"dtype": TensorProto.FLOAT8E4M3FN, "shape": [1]},
    }
    ...
    if requires_trt_inference:
        ...
        get_custom_layers.assert_not_called()
        infer_types_shapes.assert_not_called()
