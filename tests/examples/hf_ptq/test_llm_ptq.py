...
@pytest.mark.parametrize(
    ...
    [
        ...
        # GGML weight-only, recipe-driven. The IQ encoders require every weight's input
        # dimension to be a multiple of 256; Q8_0 requires 32. TinyLlama's 2048 and 5632
